...
// 2. Definir valores padrão para controlador e ação
$controladorNome = $_GET['controlador'] ?? 'carro';
$acao = $_GET['acao'] ?? 'index';

// 3. Montar o nome do arquivo do controlador
...
// 4. Verificar se o arquivo do controlador existe antes de incluí-lo
...
// 5. Incluir o arquivo do controlador
require_once $caminhoControlador;

// 6. Verificar se a função (ação) solicitada existe no controlador
